                ...
                <div class="panel-body">
                    <form role="form" action="${PATH}/admin/updateAdmin" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="loginacct" class="form-control" id="exampleInputLoginacct" value="${admin.loginacct}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername">用户名称</label>
                            <input type="text" name="username" class="form-control" id="exampleInputUsername" value="${admin.username}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail">邮箱地址</label>
                            <input type="email" name="email" class="form-control" id="exampleInputEmail" value="${admin.email}">

        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="${PATH}/admin/addAdmin" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="username" class="form-control" id="exampleInputUsername" placeholder="请输入用户名称">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword">密码</label>
                            <input type="text" name="userpswd" class="form-control" id="exampleInputPassword" placeholder="请输入用户名称">
                        </div>
                        <div class="form-group">
